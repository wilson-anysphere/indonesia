...
stable_harness_checks=(
  # `nova-db` integration tests are primarily consolidated into a single harness binary, but we
  # allow an optional second harness for targeted typeck-focused integration tests.
