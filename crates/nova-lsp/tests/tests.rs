...
mod suite {
    ...
    #[cfg(feature = "ai")]
    #[path = "semantic_search_config_reload_watched_files_stdio.rs"]
    mod semantic_search_config_reload_watched_files_stdio;
    #[cfg(feature = "ai")]
    #[path = "semantic_search_excluded_paths_reload_stdio.rs"]
    mod semantic_search_excluded_paths_reload_stdio;
    #[cfg(feature = "ai")]
