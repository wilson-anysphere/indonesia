...
#[test]
fn go_to_implementation_on_new_expression_receiver_resolves_default_interface_method_definition() {
    let fixture = FileIdFixture::parse(
        r#"
//- /I.java
interface I { default void $1foo(){} }
...
#[test]
fn go_to_implementation_on_static_receiver_call_does_not_walk_subtypes() {
    let fixture = FileIdFixture::parse(
        r#"
//- /A.java
class A { static void $1foo() {} }
//- /B.java
class B extends A { static void $2foo() {} }
//- /Main.java
class Main { void test(){ A.$0foo(); } }
"#,
    );
...
#[test]
fn go_to_implementation_on_second_var_local_receiver_in_comma_separated_decl() {
    let fixture = FileIdFixture::parse(
        r#"
//- /Foo.java
class Foo { void $1bar(){} }
//- /Main.java
class Main { void test(){ var a = new Foo(), b = new Foo(); b.$0bar(); } }
"#,
    );
...
class Foo { void $1bar(){} }
//- /Main.java
class Main { Foo a, b = new Foo(); void test(){ b.$0bar(); } }
"#,
    );
...
#[test]
fn go_to_type_definition_on_variable_with_dollar_prefixed_type_returns_class() {
    let fixture = FileIdFixture::parse(
        r#"
//- /$Proxy0.java
class $1$Proxy0 {}
