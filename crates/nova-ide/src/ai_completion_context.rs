...
"#,
    ...
    #[test]
    fn class_literal_receiver_type_and_methods_are_semantic() {
        let ctx = ctx_for(
            r#"
class A {
  void m() {
...
"#,
    ...
    #[test]
    fn receiver_type_infers_parenthesized_this_receiver_type_and_methods() {
        let ctx = ctx_for(
            r#"
class Test {
    void bar() {}
...
"#,
    ...
    #[test]
    fn receiver_type_infers_parenthesized_this_receiver_with_comment_before_nested_parens() {
        let ctx = ctx_for(
            r#"
class Test {
    void bar() {}
...
"#,
    ...
    #[test]
    fn receiver_type_infers_parenthesized_super_receiver_type_and_methods() {
        let ctx = ctx_for(
            r#"
class Base {
  void base() {}
...
"#,
    ...
    #[test]
    fn receiver_type_infers_parenthesized_super_receiver_with_comment_before_nested_parens() {
        let ctx = ctx_for(
            r#"
class Base {
  void base() {}
...
"#,
    ...
    #[test]
    fn cast_receiver_type_and_methods_are_semantic() {
        let ctx = ctx_for(
            r#"
class A {
  void m(Object obj) {
...
"#,
    ...
    #[test]
    fn anonymous_class_receiver_with_trailing_block_comment_before_body_is_semantic() {
        let ctx = ctx_for(
            r#"
class Foo {
  void bar() {}
...
"#,
    ...
    #[test]
    fn generic_constructor_call_receiver_type_and_methods_are_semantic() {
        let ctx = ctx_for(
            r#"
class Foo<T> {
  void bar() {}
...
"#,
    ...
    #[test]
    fn diamond_constructor_call_receiver_type_and_methods_are_semantic() {
        let ctx = ctx_for(
            r#"
class Foo<T> {
  void bar() {}
...
"#,
    ...
    #[test]
    fn parenthesized_class_literal_receiver_is_semantic() {
        let ctx = ctx_for(
            r#"
class A {
  void m() {
...
"#,
        ...
        let receiver_ty = ctx.receiver_type.as_deref().unwrap_or("");
        assert!(
            receiver_ty.contains("Class"),
            "expected receiver type to contain `Class`, got {receiver_ty:?}"
        );
        assert!(ctx.available_methods.iter().any(|m| m == "getName"));
    }
...
"#,
    ...
    #[test]
    fn array_access_receiver_with_trailing_block_comment_before_index_is_semantic() {
        let ctx = ctx_for(
            r#"
class A {
  void m() {
...
"#,
    ...
    #[test]
    fn parenthesized_call_receiver_with_trailing_block_comment_in_chain_is_semantic() {
        let ctx = ctx_for(
            r#"
class A {
  String b() { return "x"; }
...
"#,
    ...
    #[test]
    fn parenthesized_call_receiver_with_trailing_line_comment_in_chain_is_semantic() {
        let ctx = ctx_for(
            r#"
class A {
  String b() { return "x"; }
...
"#,
    ...
    #[test]
    fn parenthesized_call_chain_field_access_receiver_with_trailing_block_comment_in_chain_is_semantic(
    ) {
        let ctx = ctx_for(
            r#"
class B {
...
"#,
    ...
    #[test]
    fn parenthesized_call_chain_field_access_receiver_with_trailing_line_comment_in_chain_is_semantic(
    ) {
        let ctx = ctx_for(
            r#"
class B {
