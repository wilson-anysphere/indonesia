...
mod json_error_sanitization_tests {
    ...
    fn sanitize_anyhow_error_message_does_not_echo_toml_snippet_blocks() {
        let secret_suffix = "nova-devtools-toml-snippet-secret";
        let message = format!(
    ...
    fn sanitize_anyhow_error_message_does_not_echo_toml_debug_raw_source() {
        let secret_suffix = "nova-devtools-toml-debug-secret";
        let debug = format!(
    ...
    fn sanitize_anyhow_error_message_does_not_echo_toml_single_quoted_values() {
        let secret_suffix = "nova-devtools-toml-single-quote-secret";
