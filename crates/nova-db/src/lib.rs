...
pub use salsa::{
    ...
    NovaIndexing, NovaInputs, NovaResolve, NovaSemantic, NovaSyntax, QueryStat, QueryStatReport,
    QueryStats, QueryStatsReport, RootDatabase as SalsaRootDatabase, Snapshot, SyntaxTree,
};
