...
mod tests {
    ...
    mod unicode_tests {
        ...
        #[test]
        fn georgian_uppercase_lowercase_match() {
            // Georgian has distinct uppercase (Mtavruli) and lowercase (Mkhedruli) codepoints.
            // Unicode case folding should treat them as equivalent.
            assert!(fuzzy_match("ჭ", "Ჭ").is_some());
            assert!(fuzzy_match("Ჭ", "ჭ").is_some());
        }
